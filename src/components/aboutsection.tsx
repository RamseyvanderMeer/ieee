  ...
  return (
    <div className="relative flex h-fit min-h-[75vh] w-screen flex-col items-center justify-center">
      ...
      <div className="flex md:flex-row flex-col">
        ...
        <div className="w-[30vw] w-full border-white border-2 items-center justify-center rounded p-3 px-3 py-2 font-bold text-white hover:bg-slate-800 hover:text-white md:inline-flex md:w-auto">
